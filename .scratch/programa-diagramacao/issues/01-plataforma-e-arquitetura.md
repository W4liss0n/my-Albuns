...
- 2026-07-29: a rodada com 172 JPEGs reais está em `docs/research/0008-cache-com-imagens-reais.md`. Ela valida uma representação reduzida por Foto, o consumo da mesma representação pelo Painel e pelo Canvas e mede Cache frio nas duas topologias. O critério permanece aberto até cobrir Imagens decorativas, ciclo de invalidação/falha e as medições gráficas restantes.
- 2026-07-29: a rodada de interação e Exportação está em `docs/research/0009-pan-zoom-e-exportacao-com-imagens-reais.md`. Ela mede dois Projetos nas duas topologias, com Pan e Zoom sobre texturas reais, Exportação a 300 DPI a partir dos originais, memória, contadores gráficos e processos; esse critério específico foi encerrado. Recuperação e custo operacional da IPC permanecem gates separados.
