...
const CURRENT_MIGRATION_EXPECTED: &[u8] =
    include_bytes!("fixtures/project_document_v11_migration_expected.myalbuns");
...
#[test]
fn an_authorized_editable_v2_project_promotes_to_v11_and_keeps_opaque_identity_authority() {
