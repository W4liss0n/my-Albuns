...
const CURRENT_MIGRATION_EXPECTED: &[u8] =
    include_bytes!("fixtures/project_document_v10_migration_expected.myalbuns");
...
#[test]
fn an_authorized_editable_v2_project_promotes_to_v10_and_keeps_opaque_identity_authority() {
...
#[test]
fn explicit_save_promotes_an_open_v1_project_to_the_versioned_v10_golden_result() {
