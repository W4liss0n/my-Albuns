...
const PROJECT_V4_MIGRATION_EXPECTED: &[u8] =
    include_bytes!("fixtures/project_document_v5_migration_expected.myalbuns");
...
#[test]
fn an_authorized_editable_v2_project_promotes_to_v5_and_keeps_opaque_identity_authority() {
...
#[test]
fn explicit_save_promotes_an_open_v1_project_to_the_versioned_v5_golden_result() {
