...
A [integração com Photoshop](docs/research/2026-09-11-integracao-photoshop.md) permite escolher uma instalação em Configurações e abrir o Original de uma Foto pelo menu contextual ou por `Ctrl+E`. Alterações externas são observadas pelo ciclo de mídia existente, sem acrescentar ações ao Histórico do Projeto.
