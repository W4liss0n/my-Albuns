...
A [troca de conteúdo entre dois Frames](docs/research/2026-09-08-troca-de-conteudo-de-frames.md) permite trocar duas Fotos ou mover uma Foto para um placeholder por Editar e pelo menu contextual. Cada ocorrência leva seu vínculo, Pan e Zoom; identidade, geometria, estilo e ordem permanecem nos Frames. A seleção é preservada e a troca forma uma ação de Undo/Redo, com Salvamento e reabertura.
