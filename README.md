...
O [primeiro recorte da edição de Frames](docs/research/2026-09-07-geometria-de-frame-unico.md) acrescenta movimento e redimensionamento de um Frame no Modo de edição da Lâmina, com oito alças, Shift/Alt, prévia calculada pelo núcleo e uma ação de Undo/Redo por gesto. A geometria acompanha Salvamento, reabertura e exportação JPEG. Seleção múltipla e os demais comandos continuam na issue #20.
