...
| Ações secundárias da tela de boas-vindas | `Configurações…` e `Exportação em lote` mantêm fundo transparente e posição. Texto e ícone vão de cinza secundário a grafite no hover e foco visível; só o rótulo recebe sublinhado fino. Ação desabilitada não reage. | [0002](../docs/design/0002-tela-de-boas-vindas.md) |
