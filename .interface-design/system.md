...
| Ações secundárias da tela de boas-vindas | `Configurações…` e `Exportação em lote` mantêm fundo transparente e posição. Texto e ícone vão de cinza secundário a grafite no hover e foco visível, sem sublinhado. Ação desabilitada não reage. | [0002](../docs/design/0002-tela-de-boas-vindas.md) |
...
| Visualizador de imagens em janela própria | Janela owned com superfície neutra quente e imagem inteira como foco. No encaixe, imagem proporcional e centralizada com pelo menos 24 px de respiro nas quatro bordas da área de visualização (`--ui-space-5`). A barra da janela mostra somente o nome truncado e os controles nativos. Setas e ajuste como ícones diretamente sobre a imagem, sem discos de fundo, com área clicável ampla e foco visível. Estados transitórios ficam na área da imagem. Sem barra de ferramentas, contador ou porcentagem. | [0050](../docs/design/0050-visualizador-integrado-de-imagens.md) |
| Correção de olhos no visualizador | Abrir olhos fica no canto superior direito e se transforma em Fechar correção no mesmo ponto, com o mesmo visual; ações próximas se estendem para a esquerda com revelação discreta, respeitando movimento reduzido. Grupo flutuante sem caixa, barra de fundo ou rodapé, usando `ImageToolButton` (alvo de 42 px; setas de 26 px, ferramentas de 18 px; tooltip compartilhado; foco visível). Durante a correção, nomes de arquivos ficam ocultos nos painéis e na barra da janela; permanecem rótulos curtos de referência e destino. Referência à esquerda e destino à direita, com áreas de imagem iguais. Antes e depois alterna apenas a imagem de destino; Salvar correção confirma o resultado preparado. Progresso e erro essenciais flutuam sem competir com o grupo ou deslocar as imagens. Marcadores de rosto têm alvo de 42 px e núcleo visual de 20 px, deslocado dos olhos e com seleção clara. | [0050](../docs/design/0050-visualizador-integrado-de-imagens.md) |
