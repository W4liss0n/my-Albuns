...
| Correção de olhos no visualizador | Abrir olhos fica no canto superior direito e se transforma em Fechar correção no mesmo ponto. Seu fundo circular se prolonga à esquerda em uma cápsula contínua translúcida, sem discos separados, bordas, divisórias ou sombra; revelação discreta com movimento reduzido respeitado. Usa ImageToolButton (alvo de 42 px, ícones de 18 px, superfície de 36 px de altura, tooltip e foco acessíveis). Imagens inteiras e proporcionais ocupam as duas metades com 24 px de respiro, sem nomes, rótulos ou faixa reservada para ferramentas. Antes e depois indica seu estado no botão e no tooltip; Salvar confirma o resultado preparado. Rostos recebem caixas de contorno dos pontos detectados, sem numeral ou preenchimento, acompanhando zoom e deslocamento; seleção neutra e aria-pressed. Sem mensagens soltas sobre as imagens: apenas avisos necessários no tooltip da ação correspondente, acessíveis por hover e foco, inclusive para explicar uma ação indisponível. Sem textos de andamento como Analisando, Preparando ou Aplicando correção; ocupação indicada pelos controles bloqueados e pelo estado acessível. | [0050](../docs/design/0050-visualizador-integrado-de-imagens.md) |
