...
| Correção de olhos no visualizador | Abrir olhos fica no canto superior esquerdo e se transforma em Fechar correção, com ações em ícones se estendendo ao lado. Grupo flutuante sem caixa, barra de fundo ou rodapé, usando `ImageToolButton` (alvo de 42 px; setas de 26 px, ferramentas de 18 px; tooltip compartilhado; foco visível). Referência à esquerda e destino à direita, com áreas de imagem iguais. Antes e depois alterna apenas a imagem de destino; Salvar correção confirma o resultado preparado. Progresso e erro essenciais flutuam perto das ferramentas, sem deslocar as imagens. Marcadores de rosto têm alvo de 42 px e núcleo visual de 20 px, deslocado dos olhos e com seleção clara. | [0050](../docs/design/0050-visualizador-integrado-de-imagens.md) |
