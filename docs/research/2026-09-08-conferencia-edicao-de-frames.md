...
O histórico integrado até `8977b6d` entrega a base de edição de Frames. A issue
...
- **Estilos e transformações — #22:** os recortes anteriores preservam os ajustes
  existentes. Borda/Opacidade individuais, Ângulo fino, Preto e branco e os demais
  controles não se tornam entregues apenas porque Copiar ou Trocar os preservará
  quando existirem. Giro e Espelhamento constituem o próximo recorte implementado.
...
Ângulo fino, Preto e branco, Borda e Opacidade continuam para os recortes seguintes
da #22; aplicação de Layouts e travamento vêm depois, conforme a sequência acima.
