...
Coletado em UTC: `2026-08-02T03:56:20.0652265Z`.
Ordem de execução: `BA`.
[JSON bruto](0020-topology-final-ba.json).
...
| Working set agregado | 2.249,8 MiB | 2.213,3 MiB |
| Memória privada agregada | 1.702,2 MiB | 1.837,2 MiB |
| Snapshot Windows pós-probe: memória gráfica dedicada | 0,0 MiB | 0,0 MiB |
| Snapshot Windows pós-probe: memória gráfica compartilhada | 691,6 MiB | 655,9 MiB |
| Snapshot Windows pós-probe: uso dedicado + compartilhado dos processos | 691,6 MiB | 655,9 MiB |
| Duas Janelas identificadas | 1980 ms | 2527 ms |
| Duas Janelas com Cache pronto | 33668 ms | 53617 ms |
| Dois Canvas com texturas prontos | 33938 ms | 53782 ms |
| Duração de parede do Cache frio | 30736 ms | 50293 ms |
| Fotos processadas pelo Cache | 172 | 172 |
| Decorativos PNG processados pelo Cache | 2 | 2 |
| Vazão agregada dos originais | 45,6 MiB/s | 27,9 MiB/s |
| Representações reduzidas | 49,4 MiB | 49,4 MiB |
| Pan: pior p95 entre Projetos | 18.6 ms | 18 ms |
| Pan: frames acima de 33 ms | 0 | 0 |
| Zoom: pior p95 entre Projetos | 24.6 ms | 19.6 ms |
| Zoom: frames acima de 33 ms | 2 | 0 |
...
| Canvas: maior duração observada da recuperação | 150.9 ms | 133.7 ms |
| Canvas: maior latência observada do frame restaurado | 82 ms | 96.2 ms |
| Navegação: pior p95 entre Projetos | 272.5 ms | 324.8 ms |
...
| Exportação: duração | 2485 ms | 2482 ms |
