...
- A própria Lâmina oferece somente duas regiões clicáveis, lado esquerdo e lado direito; clicar no espaço vazio da área de prévia, fora da Lâmina, fixa `Ambos os lados`, e a região central da Lâmina não constitui um alvo separado.
