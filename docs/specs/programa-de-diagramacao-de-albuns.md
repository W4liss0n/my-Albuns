...
- O gesto começa depois do limiar de arraste do Windows. O Frame de destino válido recebe destaque; nas bordas do Canvas, a rolagem permite alcançar outras Lâminas. `Alt` + arraste continua reservado ao Pan.
