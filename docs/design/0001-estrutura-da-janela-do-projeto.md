...
- A cópia permanece disponível ao navegar entre Lâminas e alternar entre os modos normal e de edição do mesmo Projeto. A colagem usa a Lâmina isolada no Modo de edição; no Modo normal, usa a Lâmina do Frame selecionado ou, sem seleção, a Lâmina centralizada.
