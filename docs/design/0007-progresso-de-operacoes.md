...
- Quando nem um trabalho de imagem cabe na memória e não existe processamento ativo que possa liberar recursos, o progresso termina com um motivo recuperável. O resultado parcial preserva as imagens já validadas; depois de liberar memória, uma nova execução de Importar reaplica a regra normal de reimportação, sem duplicar vínculos. A política está detalhada na [admissão por memória](0032-revisao-da-admissao-por-memoria.md).
