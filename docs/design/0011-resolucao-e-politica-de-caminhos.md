...
A Exportação prepara o arquivo temporário dentro do próprio diretório de destino autorizado e publica o JPEG final por troca atômica. `AppPaths` não oferece namespace privado de prova nem escolhe um destino alternativo para a operação.
