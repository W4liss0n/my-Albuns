        ...
        $criteria = @(
            ...
            New-VerifiedCriterion `
                ...
                -Requirements @(
                    ...
                    (New-RustProof -Name 'explicit_retry_rejects_a_missing_authoritative_observation')
                    (New-RustProof -Name 'explicit_retry_rejects_an_occurrence_missing_from_the_authoritative_snapshot')
                    (New-RustProof -Name 'explicit_retry_rejects_available_occurrences_without_changing_runtime')
                    ...
                    (New-FrontendProof -Name 'keeps recovery actions hidden until the first authoritative media observation')
