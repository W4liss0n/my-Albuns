...
const port: ProjectGenerationPort = {
  ...
  prepare: async () => { if (scenario === "verification-cancelled") return null; if (scenario === "error") throw "Não foi possível acessar a pasta de origem. Verifique a conexão e tente novamente."; return base; }, decide: async () => base, recheck: async () => base, run: async () => base,
